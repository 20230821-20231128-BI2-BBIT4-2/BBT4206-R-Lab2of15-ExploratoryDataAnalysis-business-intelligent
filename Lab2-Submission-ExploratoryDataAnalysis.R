...
#mode for students who would drop BI
...
#frequency for students who read content before lecture
student_performance_dataset_freq <- student_performance_dataset$read_content_before_lecture
